...
| `tests/cli/drivers_spec.lua` | UI drivers: plain render/prompt/notify, ansi color escapes, --ui driver injection via engine.new, driver.is_driver contract, plain/ansi/curses lifecycle stubs, curses driver shape (lazy init, attach/detach, is_available), --ui whitelist incl. curses (35 tests) |
